...
class DP2031:
    def __init__(self, resource_name, reset=True):
        ...
        if "Rigol" in self.get_id():
            print("DP2031 connected successfully.")
        else:
            raise ValueError("Failed to connect to DP2031.")
...
if __name__ == "__main__":
    resource_name = 'USB0::0x1AB1::0xA4A8::DP2A242800127::INSTR'
    power_supply = DP2031(resource_name)
    power_supply.output_on()
    power_supply.set_voltage('CH3', 2)
    power_supply.set_current('CH3', 1)